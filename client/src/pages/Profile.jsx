...
import { getDownloadURL, getStorge, ref, uploadBytesResumable } from "firebase/storage";
...
export default function Profile() {
  ...
  const handleFileUpload = (file) => {
    ...
    uploadTask.on('state_changed', 
      ...
      // a callback function that is called when the upload is complete
      ()=>{
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        ...
        <p className="text-sm self-center">
          {fileUploadError ?
            ...
            <span className="text-gray-500">Upload a new profile picture</span>
          }
        </p>
        <input
          type="text"
